...
export class all1587427675128 implements MigrationInterface {
    name = 'all1587427675128'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "Organization" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "email" character varying NOT NULL, "logoURL" character varying NOT NULL, "foundIn" TIMESTAMP NOT NULL, "industry" character varying NOT NULL, "description" character varying NOT NULL, "contactPhone" character varying NOT NULL, "verified" boolean NOT NULL DEFAULT true, CONSTRAINT "PK_67bcafc78935cd441a054c6d4ea" PRIMARY KEY ("id"))`, undefined);
        ...
        await queryRunner.query(`CREATE TABLE "User" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "email" character varying NOT NULL, "username" character varying NOT NULL, "verified" boolean NOT NULL, CONSTRAINT "PK_9862f679340fb2388436a5ab3e4" PRIMARY KEY ("id"))`, undefined);
    }
